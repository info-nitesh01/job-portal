...
export default function PrfilePage() {
    ...
    let currentUser: any;
    if (typeof window !== 'undefined') { currentUser = JSON.parse(localStorage.getItem('userdata') as string) }
        ...
        <>
            {loading ? <div className="h-dvh w-full flex items-center justify-center"><span className="loader"></span></div> :
                <>
                    ...
                    <UserNav />
                    <div className="bg-theme-green text-center h-96 flex items-center flex-col justify-center mb-10">
