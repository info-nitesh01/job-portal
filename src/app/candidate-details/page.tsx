...
import { ArrowDownTrayIcon, EyeIcon, InboxArrowDownIcon, MapPinIcon, PhoneIcon } from "@heroicons/react/16/solid";
        ...
        <>
            ...
            {(filteredApiData !== null && filteredApiData !== undefined) ?
                filteredApiData.map((item: any, id: number) =>
                    <div key={id} className='grid grid-cols-12 mx-24 my-20'>
                        <div className="col-span-5 shadow-lg">
                            ...
                            <div className="m-12 tracking-wider">
                                ...
                                <div className="text-base text-gray-500 leading-8">
                                    <Link href="#" className="flex items-center hover:text-gray-800"><PhoneIcon className="h-6 text-theme-green me-2" />{item.phone}</Link>
                                    <Link href="#" className="flex items-center hover:text-gray-800"><InboxArrowDownIcon className="h-6 text-theme-green me-2" />{item.email}</Link>
                                    <Link href="#" className="flex items-center hover:text-gray-800"><MapPinIcon className="h-6 text-theme-green me-2" />{item.address}</Link>
                                </div>
