...
export default function FooterComponent() {
    return (
        <Footer className="bg-theme-green rounded-none px-24">
            <div className="w-full">
                <div className="grid w-full grid-cols-1 gap-8 px-6 py-8 md:grid-cols-4">
                    <div>
                        <Link href="/">
                            <img src="https://templates.hibootstrap.com/gable/default/assets/img/logo-two.png" className="mr-3 h-14 mb-5" alt="Flowbite React Logo" />
                        </Link>
                    ...
                    <div>
                        ...
                        <Footer.LinkGroup col className="text-white text-base">
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Development</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Business</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Tech & IT</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Networking</Link>
                        </Footer.LinkGroup>
                    </div>
                    <div>
                        ...
                        <Footer.LinkGroup col className="text-white text-base">
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Home</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />About Us</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Blogs</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Companies</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><ChevronRightIcon className="h-5" />Testimonials</Link>
                        </Footer.LinkGroup>
                    </div>
                    <div>
                        ...
                        <Footer.LinkGroup col className="text-white text-base">
                            <Link href="#" className="flex items-center hover:text-gray-800"><MapPinIcon className="h-5 me-1" /> 28/A Street, New York City</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><PhoneIcon className="h-5 me-1" />+88 0123 456 789</Link>
                            <Link href="#" className="flex items-center hover:text-gray-800"><InboxArrowDownIcon className="h-5 me-1" />hello@gable.com</Link>
                        </Footer.LinkGroup>
                    </div>
                </div>
